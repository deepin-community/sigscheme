...
/* /source/src/sigschemeinternal.h */
#undef SYM_QUOTE
...
/* /source/src/scmport.h */
#undef SCM_DEBUG_PORT
#undef SCM_ERRMSG_OPEN_PORT
#undef SCM_ERRMSG_CLOSE_PORT
#undef SCM_ERRMSG_READ_FROM_PORT
#undef SCM_ERRMSG_WRITE_TO_PORT
#undef SCM_PORT_ASSERT
#undef SCM_PORT_ERROR_INVALID_TYPE
#undef SCM_PORT_ERROR_INVALID_OPERATION
#undef SCM_PORT_ERROR_NOMEM
#undef SCM_CHARPORT_DYNAMIC_CAST
#undef SCM_BYTEPORT_DYNAMIC_CAST
#undef SCM_PORT_DYNAMIC_CAST
#undef SCM_PORT_TRY_DYNAMIC_CAST
#undef SCM_CHARPORT_CLOSE
#undef SCM_CHARPORT_CODEC
#undef SCM_CHARPORT_ENCODING
#undef SCM_CHARPORT_CCS
#undef SCM_CHARPORT_INSPECT
#undef SCM_CHARPORT_GET_CHAR
#undef SCM_CHARPORT_PEEK_CHAR
#undef SCM_CHARPORT_CHAR_READYP
#undef SCM_CHARPORT_PUTS
#undef SCM_CHARPORT_PUT_CHAR
#undef SCM_CHARPORT_FLUSH
#undef SCM_BYTEPORT_CLOSE
#undef SCM_BYTEPORT_INSPECT
#undef SCM_BYTEPORT_GET_BYTE
#undef SCM_BYTEPORT_PEEK_BYTE
#undef SCM_BYTEPORT_BYTE_READYP
#undef SCM_BYTEPORT_PUTS
#undef SCM_BYTEPORT_WRITE
#undef SCM_BYTEPORT_FLUSH

/* /source/src/scmport-config.h */
#undef SCM_PORT_MALLOC
#undef SCM_PORT_CALLOC
#undef SCM_PORT_REALLOC
#undef SCM_PORT_STRDUP
#undef SCM_CHARPORT_ERROR
#undef SCM_BYTEPORT_ERROR

/* /source/src/scmport-file.h */

/* /source/src/scmport-file.c */
#undef OK

/* /source/src/scmport-basechar.c */

/* /source/src/encoding-config.h */
#undef SCM_ENCODING_ASSERT
#undef SCM_ENCODING_ERROR
#undef SCM_ENCODING_CDBG
#undef SCM_ENCODING_DBG
#undef SCM_USE_UTF8
#undef SCM_USE_EUCJP
#undef SCM_USE_EUCCN
#undef SCM_USE_EUCKR
...
/* /source/src/scmport-mbchar.h */

/* /source/src/scmport-mbchar.c */
#undef HANDLE_MBC_START
#undef SCM_MBCPORT_CLEAR_STATE
#undef static
#undef l_ScmMultiByteCharPort_vtbl

/* /source/src/scmport-sbchar.h */

/* /source/src/scmport-sbchar.c */
#undef static
#undef l_sbc_codec
...
/* /source/src/deep-cadrs.c */

/* /source/src/module-sscm-ext.c */
#undef ERRMSG_INVALID_BINDINGS
#undef ERRMSG_INVALID_BINDING

/* /source/src/module-siod.c */
...
/* /source/src/scmport-null.h */

/* /source/src/scmport-null.c */

/* /source/src/module-srfi1.c */

/* /source/src/module-srfi2.c */

/* /source/src/module-srfi6.c */

/* /source/src/scmport-str.h */

/* /source/src/scmport-str.c */

/* /source/src/module-srfi8.c */

/* /source/src/module-srfi9.c */
...
/* /source/src/module-srfi23.c */

/* /source/src/module-srfi28.c */

/* /source/src/module-srfi34.c */
...
/* /source/src/module-srfi38.c */

/* /source/src/module-srfi43.c */
#undef QUOTE
#undef static
...
/* /source/src/module-srfi48.c */

/* /source/src/module-srfi55.c */
#undef static
#undef l_sym_require_extension

/* /source/src/module-srfi60.c */
#undef BITWISE_OPERATION_BODY

/* /source/src/gcroots/gcroots.h */
#undef _GCROOTS_H
...
/* /source/src/main.c */
#undef PROMPT_STR
#undef FEATURE_ID_SIOD
#undef MAXPATHLEN
#undef SCM_BREW_USER_APPLET_T
#undef sscm
